...
class UsersMapperTest {
    ...
    @Test
    fun `test usersMapper given userDomainModel when invoke mapUserDomainModelToUserEntity then return UsersEntity`() = runTest {
        val mockedUserDomainModel=UserDomainModel("name","1","email","password",null)
        val expectedEntity=UserEntity(username = "name", phoneNumber = "1", email = "email", password = "password", userImagePath = null)
